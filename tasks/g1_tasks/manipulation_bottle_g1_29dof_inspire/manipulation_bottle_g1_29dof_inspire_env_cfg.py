...
from tasks.common_scene.base_scene_manipulation_bottle import TableBottleSceneCfg
...
@configclass
class ObjectTableSceneCfg(TableBottleSceneCfg):
...
class TerminationsCfg:
    ...
    success = DoneTerm(func=mdp.task_done)# use task completion check function
...
class EventCfg:
    reset_object = EventTermCfg(
        func=mdp.reset_root_state_uniform_double,  # use uniform distribution reset function
        ...
        params={
            ...
            "asset_0_cfg": SceneEntityCfg("bottle"),
            "asset_1_cfg": SceneEntityCfg("cap"),
        },
    )


@configclass
class ManipulationG129InspireBaseFixEnvCfg(ManagerBasedRLEnvCfg):
    """
